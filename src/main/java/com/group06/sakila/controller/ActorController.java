...
public class ActorController {
    ...
    //Create actor
    @PostMapping("")
    ResponseEntity<Actor> createActor(@RequestBody ActorRequest actorRequest) {
        return actorService.createActor(actorRequest);
    }

    //Update actor
    @PutMapping("/{id}")
    ResponseEntity<Actor> updateActor(@RequestBody ActorRequest actorRequest, @PathVariable Long id) {
